...
import { deleteUserRequest, getUserRequest, updateUserRequest } from '../services/api.js';
                ...
                <div className='form-container 50-w p-5 rounded'>
                    ...
                    <form onSubmit={handleUpdate}>
                        ...
                        <div className='button-container d-flex justify-content-between'>
                            ...
                            <button type='button' onClick={handleDelete} className='btn btn-primary'>Eliminar</button>
                        </div>
                    </form>
                </div>
            </div>
