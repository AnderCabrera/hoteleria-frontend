      ...
      <div className="container-information">
        ...
        <div className="container-information-right">
          ...
          <p className="container-information-letter">
            Kinal Stay S.A, Somos una Empresa de hotelería dedicada a
            proporcionar servicios de alojamiento y hospitalidad a los huéspedes
            que viajan por placer o negocios.Trabajamos con diferentes hoteles
            alrededor del mundo que operan hoteles, resorts, posadas u otras
            formas de alojamiento temporal.
          </p>
          <br />
          <br />
          <h2>MISIÓN</h2>
          <p className="container-information-letter">
            Nuestra misión es ofrecer un servicio seguro, confiable y eficaz a
            todos nuestros clientes, contamos con distintos precios, muy
